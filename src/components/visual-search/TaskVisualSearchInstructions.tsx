    ...
    return (
        <div className="h-full w-full grid font-sans grid-rows-5 gap-2 px-80 py-5">
            ...
            <div className=" text-lg row-span-3 grid grid-rows-3 gap-8 px-10 py-5 mx-10 rounded-lg border-2 border-dashed">
                ...
                <div className="flex items-center justify-center">Press<KeyboardIcon>J</KeyboardIcon><span>if there <b>is</b> a </span><span className="h-[32px] mx-3"><StimulusTarget></StimulusTarget></span> anywhere in the grid of symbols</div>
                <div className="flex items-center justify-center">Press<KeyboardIcon>F</KeyboardIcon><span>if there <u>is not</u> a </span><span className="h-[32px] mx-3"><StimulusTarget></StimulusTarget></span>in the grid of symbols</div>
