...
const DecoderLevelFeedback: React.FC<DecoderLevelProps> = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-full bg-gradient-to-t from-stone-400 to-stone-300 dark:from-gray-900 dark:to-slate-900 font-[family-name:var(--font-geist-sans)]">
      <div className=" text-gray-800 dark:text-gray-200 flex flex-col justify-center items-center flex-grow p-4 m-4 space-y-20 min-w-[500px] border-2 border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-900 shadow-lg dark:shadow-inset-game-panel rounded-2xl overflow-y-auto">
