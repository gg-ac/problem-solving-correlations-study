...
const ResetButton: React.FC<ResetButtonProps> = ({ onClick }) => {
  return (
    <div
      ...
      active:border-b-[0px] [box-shadow:0_0.35rem_0_0_#be123c,0_0.35rem_0_0.125rem_#00000033] sm:[box-shadow:0_0.5rem_0_0_#be123c,0_0.5rem_0_0.25rem_#00000033]
      border-b-[2px] border-rose-400
      flex-grow flex-shrink
      min-w-4 min-h-4 max-w-16 max-h-16'
      >
        <ResetIcon className="flex stretch flex-grow flex-shrink max-w-[75%] max-h-[75%]" />
    </div>
  );
};
