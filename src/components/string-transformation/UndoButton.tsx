...
const UndoButton: React.FC<ButtonProps> = ({ onClick }) => {
  return (
      ...
      active:border-b-[0px] [box-shadow:0_0.35rem_0_0_#0f766e,0_0.35rem_0_0.125rem_#00000033] sm:[box-shadow:0_0.5rem_0_0_#0f766e,0_0.5rem_0_0.25rem_#00000033]
      border-b-[2px] border-teal-400
      flex-grow flex-shrink
      min-w-4 min-h-4 max-w-16 max-h-16'
      >
        <UndoIcon className="flex stretch flex-grow flex-shrink max-w-[75%] max-h-[75%]" />
      </div>
  );
};
